...
def does_backup_vault_exist_for_name(bkp_client, backup_vault_name):
    backup_vaults = (bkp_client.list_backup_vaults())['BackupVaultList']
...
def parse_request_and_prepare_response(event):
    ...
    for input_parameter in input_parameters:
        ...
        elif input_parameter["name"] == "BackupPlanId":
            backup_plan_id = input_parameter["value"]
    ...
    response = {
        ...
        "response": {
            ...
            "functionResponse": {
                ...
                "responseBody": {
                    'TEXT': {
                        'body': ' '.join(response_body_text_list)
                    }
                }
            }
        },
